	...
	Map.prototype = {
		...
		init_d3: function() {
			...
			geoConfig = function() {
				...
				this.mercator = d3.geo.orthographic();
		...
		add_plain: function(x, y, z, color) {
			...
			var spGeo			=	new THREE.SphereGeometry(150, 50, 50);
			var planetTexture	=	THREE.ImageUtils.loadTexture('/assets/img/world-big-2-grey.jpg');
